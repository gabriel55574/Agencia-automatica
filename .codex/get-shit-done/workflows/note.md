...
- **Global scope**: `/Users/gabrielviniciusoliveira/Agencia automatica/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gabrielviniciusoliveira/Agencia automatica/.codex/notes/`)
...
2. Glob `/Users/gabrielviniciusoliveira/Agencia automatica/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gabrielviniciusoliveira/Agencia automatica/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gabrielviniciusoliveira/Agencia automatica/.codex/notes/` — works in any directory
