...
<reference>
@/Users/gabrielviniciusoliveira/Agencia automatica/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/gabrielviniciusoliveira/Agencia automatica/.claude/get-shit-done/references/user-profiling.md` to load:
