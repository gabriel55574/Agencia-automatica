...
- **Global scope**: `/Users/gabrielviniciusoliveira/Agencia automatica/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gabrielviniciusoliveira/Agencia automatica/.claude/notes/`)
...
2. Glob `/Users/gabrielviniciusoliveira/Agencia automatica/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gabrielviniciusoliveira/Agencia automatica/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gabrielviniciusoliveira/Agencia automatica/.claude/notes/` — works in any directory
