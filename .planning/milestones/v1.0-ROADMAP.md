...
Plans:
- [x] 09-01-PLAN.md — Feedback extraction engine: extractFeedbackContext function (NPS/CLV/churn from process-16 structured_output), assembler integration, reset_pipeline_cycle PostgreSQL RPC, unit tests
- [x] 09-02-PLAN.md — UI layer: resetPipelineAction Server Action, CycleBadge component, ResetPipelineDialog, PromptPreviewModal feedback section, client profile wiring, DB push + end-to-end verification
